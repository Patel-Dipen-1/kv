...
import { getAllEvents, deleteEvent, clearError, getEventById } from "./eventSlice";
...
const AdminEvents = () => {
  ...
  }, [dispatch, page, isAdmin, navigate]);
                  ...
                  <Card key={event._id} className="hover:shadow-lg transition-shadow h-full flex flex-col">
                    ...
                    <div className="pt-4 border-t mb-4">
                      <div className="flex items-center gap-4 text-sm text-gray-600">
                        ...
                        {event.settings?.pollEnabled && (
                          <div className="text-xs text-gray-500">Poll Enabled</div>
                        )}
                      </div>
                    </div>
